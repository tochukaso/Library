...
public class ArrayCommon {
     ...
     * @return 要素を追加した配列を返却する
     */
    public final int[] addArray(final int[] original, final int[] addArray) {
     ...
     * @return
     */
    public final long[][] maltipuleMatrix(long[][] lineMatrix, long[][] columnMatrix) {
     ...
     * @param p
     */
    public final void printMatrix(int[][] p) {
     ...
     * @param p
     */
    public final void printArray(int[] p) {
     ...
     * @return
     */
    public final boolean deepEquals(char[] i1, char[] i2) {
     ...
     * @return
     */
    public final boolean deepEquals(int[] i1, int[] i2) {
        if (i1.length != i2.length) return false;
        for (int i = 0 ; i < i1.length; i++) if (i1[i] != i2[i]) return false;
        return true;
    }
     ...
     * @return
     */
    public final Integer[] convIntArray(int[] arg) {
        int len = arg.length;
